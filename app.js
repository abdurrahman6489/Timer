...
//Audio to play when Timer stops
...
function progressBarIndicator(width = 0) {
  ...
  if (width >= 90) progressBarColor = "red";
  else if (width >= 80) progressBarColor = "orange";
...
function progressIndicatorPercent(percent) {
  ...
  if (percent >= 90) progressIndicatorColor = "red";
  else if (percent >= 80) progressIndicatorColor = "orange";
  else progressIndicatorColor = "green";

  if (percent > 0) progressIndicator.innerHTML = percent + "%";
  else progressIndicator.innerHTML = "";
